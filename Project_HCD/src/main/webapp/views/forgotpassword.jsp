                    ...
                    <div class="col-lg-12">
                        <div class="w-50 m-auto w-sm-100">
                            <div class="login-form">
                                ...
                                <form  method="post" 
								modelAttribute="password" action="/Project_HCD/user/changepass1" class="icon-form">
                                    <div class="form-group email">
                                        <label for="exampleInputEmail1">Email address</label>
                                        <input id="exampleInputEmail1" type="email" path="email" name="email" class="form-control bg-gray" placeholder="" required>
                                    </div>
