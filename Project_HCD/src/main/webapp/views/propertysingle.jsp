<%@page import="com.Project_HCD.model.User"%>
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" isELIgnored="false" %>
    <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form"%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<%@page import="com.Project_HCD.*"%>
	  ...
	  <div class="spinner-border" role="status">
                    ...
                    <div class="col-md-6">
                        <nav aria-label="breadcrumb" class="float-left float-md-right">
                            <ol class="breadcrumb bg-transparent m-0 p-0">
                                ...
                                <li class="breadcrumb-item"><a href="/Project_HCD/property/propertyGrid">Property</a></li>
        ...
        <div class="full-row">
                        ...
                        <div class="row">
                            <div class="col-md-12"> 
                                ...
                                <div id="single-property-2" style="width:1020px; height:640px; margin:30px auto 120px;"> 
                                    ...
                                    <!-- Slide 1-->
                                   <!--  <div class="ls-slide" data-ls="duration:4000; kenburnsscale:1.2;"> <img width="1920" height="1080" src="/Project_HCD/resources/images/slider/01.jpg" class="ls-bg" alt="" /> </div> -->
            ...
            <br>
        							<%-- hello1 ${token}
        							hello2 <c:ou ${token} --%>
                                    <div class="ls-slide" data-ls="duration:4000;"> <img width="1920" height="1080" src="/Project_HCD/resources/images/propertyPicture/${token}" class="ls-bg" alt="" /> </div>
                                    </c:forTokens>
                                    <!-- Slide 3-->
                                   <!--  <div class="ls-slide" data-ls="duration:4000;"> <img width="1920" height="1080" src="/Project_HCD/resources/images/slider/03.jpg" class="ls-bg" alt="" /> </div> -->
                                </div>
                            </div>
                        </div>
                        <div class="row mb-5">
                            <div class="col-md-6">
                                <a class="btn btn-primary mt-3" href="/Project_HCD/booking/confirmBooking/${property.propertyId}">Book Now</a>
                                <a class="btn btn-primary mt-3" href="/Project_HCD/freevisit/confirmFreeVisit/${property.propertyId}" style="margin-left:20px">Book Free Visit</a>
                            ...
                            <div class="col-md-6"> 
                                <div class="text-primary text-left h5 my-2 text-md-right">Rs. ${property.rent} Per Month</div>
						...
						<h5 class="mt-5 mb-4 text-secondary">User Reviews</h5>
								...
								<ul class="post-comments">
								 <c:forEach items="${reviewList}" var="review">
									<li class="py-4">
										<div class="avata">
											<img src="/Project_HCD/resources/images/profilePicture/${review.userProfilePicture}"
												alt="">
										</div>
							...
							<div class="mt-4 p-4 shadow-one">
								<div class="img-80 float-left mr-3 mb-4 rounded-circle">
									<img src="/Project_HCD/resources/images/profilePicture/${property.userProfilePicture}"
										alt="" width="20%">
								</div>
							...
							<div class="mt-4 p-4 shadow-one">
								<!-- <div class="img-80 float-left mr-3 mb-4 rounded-circle">
									<img src="/Project_HCD/resources/homex/images/user/02.jpg"
										alt="">
								</div> -->
								...
								<form:form class="bg-gray-input d-inline-block"
									action="/Project_HCD/review/addReview/${property.propertyId}" method="post" modelAttribute="review" enctype="multipart/form-data">
									<div class="row">
										<br>
										<br>
										<div class="col-md-12">
