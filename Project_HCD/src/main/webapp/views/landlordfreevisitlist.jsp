                               ...
                               <tbody>
                                <c:forEach items="${freevisitList}" var="freevisit">
                                        <tr>
											...
											<td><a href="/Project_HCD/freevisit/freevisitStatus/${freevisit.visitId}/accept" class="btn btn-sm bg-success-light">
												<i class="fas fa-check"></i> Accept
											</a></td>
											<td><a href="/Project_HCD/freevisit/freevisitStatus/${freevisit.visitId}/decline"class="btn btn-sm bg-danger-light">
												<i class="fas fa-times"></i> Decline
											</a></td>
										</c:if>
										<c:if test = "${freevisit.status == 'decline'}">
											
											<td><button disabled="disabled" href="/Project_HCD/freevisit/freevisitStatus/${freevisit.visitId}/decline"class="btn btn-sm bg-danger-light">
												<i class="fas fa-times"></i> Decline
											</button></td>
										</c:if>
										<c:if test = "${freevisit.status == 'accept'}">
											<td><button disabled="disabled" href="/Project_HCD/freevisit/freevisitStatus/${freevisit.visitId}/accept" class="btn btn-sm bg-success-light">
												<i class="fas fa-check"></i> Accept
											</button></td>
