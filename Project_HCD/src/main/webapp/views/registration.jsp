							...
							<div class="mt-sm-50">
								...
								<form:form class="mt-5 icon-form" method="post"
									...
									<c:choose>
										<c:when test="${edit}">
											<div>
												<div id="dvPreview">
													<img alt=""
														src="/Project_HCD/resources/images/profilePicture/${user.profilePicture}"
														style="height: 100px; width: 100px">
												</div>
												<input type="file" id="profilePicture" name="profilePicture"
													path="profilePicture"
													value="D:/Jva_tools/apache-tomcat-9.0.22/webapps/Project_HCD/resources/images/profilePicture/${user.profilePicture}" />
												<hr />
												<br />
									...
									<div class="form-group phone">
										...
										<form:input type="text" class="form-control bg-gray"
											value="91" name="mobileNo" path="mobileNo" pattern="[1-9]{10}" title="Enter Valid Mobile Number" required="true"/>
									</div>
										...
										<c:choose>
											<c:when test="${edit}">
												<input class="btn btn-primary btn-round" type="submit"
													value="Update" formaction="/Project_HCD/user/updateUser" />
												<input value="Cancel" class="btn btn-primary btn-round"
													type="submit" formaction="/Project_HCD/user/home">

											</c:when>
											<c:otherwise>
												<input class="btn btn-primary btn-round" type="submit"
													value="Register" formaction="/Project_HCD/user/addUser" />
												<input value="Cancel" class="btn btn-primary btn-round"
													type="submit" formaction="/Project_HCD/user/login">

											</c:otherwise>
										</c:choose>

										<a class="text-secondary hover-text-primary d-block mt-4"
											href="/Project_HCD/user/terms">View Terms and Conditions</a>
										<a class="text-secondary hover-text-primary d-block mt-4"
											href="/Project_HCD/user/login">Already have an Account? Login</a>
								</form:form>
							</div>
						</div>
					</div>
				...
				.change(
						function() {
							...
							$
									.ajax({
										type : 'GET',
										url : "/Project_HCD/area/getCities/"
												+ stateId,
