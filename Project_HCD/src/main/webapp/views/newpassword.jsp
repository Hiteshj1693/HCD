                    ...
                    <div class="col-lg-12">
                        <div class="w-50 m-auto w-sm-100">
                            <div class="login-form">
                                ...
                                <form  method="post" 
								modelAttribute="npass" action="/Project_HCD/user/newpass" class="icon-form">
                                    <div class="form-group email">
                                        <label>New Password</label>
                                        <input type="password" path="npassword" name="npassword" class="form-control bg-gray" placeholder="">
                                    </div>
                                    <div class="form-group email">
