                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <div class="mt-sm-50">
                            ...
                            <form:form class="mt-5 icon-form" method="post" action="/Project_HCD/user/editProfile" modelAttribute="view" 
							 ...
							 <div class="form-group address">
                                ...
                                <button type="submit" class="btn btn-primary mt-15">Register</button> -->
												...
												<input class="btn btn-primary btn-round" type="submit"
													value="Edit" formaction="/Project_HCD/user/editProfile" />
												<input class="btn btn-primary btn-round" type="submit"
													value="Delete" formaction="/Project_HCD/user/deleteUser" />
