                               ...
                               <tbody>
                                <c:forEach items="${propertyList}" var="property">
                                        <tr>
                                            ...
                                            <td>
                                            <a href="/Project_HCD/property/editProperty/${property.propertyId}" class="btn btn-primary mr-1 mb-1">
                                            Edit</a> 
                                            
                                            <a href="/Project_HCD/property/deleteProperty/${property.propertyId}" class="btn btn-primary mr-1 mb-1">
                                           Delete</a> 
                                            
                                            <a href="/Project_HCD/property/viewProperty/${property.propertyId}" class="btn btn-primary mr-1 mb-1">
                                            View</a> 
 											</td>
                                        </tr>
  									</c:forEach>
