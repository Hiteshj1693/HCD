                    ...
                    <div class="col-lg-12">
                        <div class="w-50 m-auto w-sm-100">
                            <div class="login-form">
								...
								modelAttribute="cpass" action="/Project_HCD/user/change" class="icon-form">
								...
								<center>
                                  <div>
                                       ...
                                       <a href="/Project_HCD/user/home"><button type="submit" class="btn btn-primary mt-3">Reset</button></a>
