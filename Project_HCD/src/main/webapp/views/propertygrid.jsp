...
<%@ page import="com.Project_HCD.model.City"%>
<!DOCTYPE html>
<html>
<head>
...
<div class="color-panel">
  <form:form method="post" modelAttribute="filters" action="/Project_HCD/property/filters">
	<div class="on-panel bg-primary"><img class="photos" src="/Project_HCD/resources/images/settings.png" alt=""></div>
							...
							<div class="col-md-12">
                                <nav aria-label="Page navigation">
                                    <ul class="pagination justify-content-center mt-4">
										<li class="page-item"> <a class="page-link" href="/Project_HCD/property/beds">Beds</a> </li>
                                        <li class="page-item"> <a class="page-link" href="/Project_HCD/property/rooms">Rooms</a> </li>
                                        <li class="page-item"> <a class="page-link" href="/Project_HCD/property/apartments">Houses</a> </li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                       ...
                       <c:forEach items="${property}" var="property">
                            <div class="col-md-6 col-lg-4">
                                <div class="featured-thumb hover-zoomer mb-4">
                                    <div class="overlay-black overflow-hidden position-relative"> <img width="250" height="250" src="/Project_HCD/resources/images/propertyPicture/${property.propertyPicture} " alt="">
                                    ...
                                    <div class="featured-thumb-data shadow-one">
                                        <div class="p-4">
                                            <h5 class="text-secondary hover-text-primary mb-2"><a href="/Project_HCD/property/viewProperty/${property.propertyId}">${property.title}</a></h5>
