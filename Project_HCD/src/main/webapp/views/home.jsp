...
<div id="page-wrapper">
	...
	<header id="header" class="transparent-header-modern fixed-header-bg-white w-100">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <ul class="top-contact list-text-white ml-3 d-table">
                                <li><a href="callto:012345678102"><i class="fas fa-phone-alt text-primary mr-1"></i>090166 47480</a></li>
        ...
        <div class="full-row overflow-hidden p-0">
            <div id="gastronomy-slider" style="width:1280px; height:520px; margin:0 auto; margin-bottom: 0px;"> 
                ...
                <!-- Slide 1-->
                <div class="ls-slide" data-ls="kenburnsscale:1.2; duration:12000;"> <img width="1920" height="960" src="/Project_HCD/resources/images/slider/04.jpg" class="ls-l" alt="" style="top:-339px; left:-260px; text-align:initial; font-weight:400; font-style:normal; text-decoration:none; mix-blend-mode:normal; filter:blur(10px);" data-ls="showinfo:1; durationin:1500; easingin:easeOutQuint; rotateyin:-5; scalexin:.8; scaleyin:.8; filterin:blur(30px); loop:true; loopduration:5000; loopstartat:allinend + 0; loopeasing:easeInOutSine; loopscalex:.8; loopscaley:.8; loopcount:1; loopfilter:blur(0px);">
                   ...
                   <c:forEach items="" var="property">
                            <div class="col-md-6 col-lg-4">
                                <div class="featured-thumb hover-zoomer mb-4">
                                    <div class="overlay-black overflow-hidden position-relative"> <img width="250" height="250" src="/Project_HCD/resources/images/home5.jpg" alt="">
                                        <div class="featured bg-primary text-white">New</div>
                                        <div class="sale bg-secondary text-white">For Rent</div>
                                        <div class="price text-primary">Rs.5000/month </div>
                                       
                                    </div>
                                    
                                    <div class="featured-thumb-data shadow-one">
                                        <div class="p-4">
                                            <h5 class="text-secondary hover-text-primary mb-2"><a href="/Project_HCD/property/viewProperty">Properties</a></h5>
                                            <span class="location"><i class="fas fa-map-marker-alt text-primary"></i> Rajkot</span> </div>
                                        <div class="px-4 pb-4 d-inline-block w-100">
                                            <div class="float-left"><i class="fas fa-user text-primary mr-1"></i> Hiesh Jethava</div>
                                            <div class="float-right"><i class="far fa-calendar-alt text-primary mr-1"></i> 11/11/2022</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 col-lg-12"> <a class="btn btn-primary mt-5 d-table mx-auto" href="/Project_HCD/property/propertyGrid">More Properties</a> </div>
 ...
 -->                        <div class="col-lg-4 col-md-6">
        ...
        <!--	Massage Box Two
        ============================================================-->
        <div class="full-row overlay-secondary" style="background-image: url('/Project_HCD/resources/images/massagetwo.jpg'); background-position: center center; background-repeat: no-repeat;">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
