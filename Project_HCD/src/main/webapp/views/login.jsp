                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <div class="mt-sm-50"> <a href="login.html" class="down-active text-secondary mr-3">Login</a>
                            ...
                            <form method="post" action="/Project_HCD/user/loggingIn" modelAttribute="log" class="mt-5 icon-form">
                              ...
                              <label for="exampleInputEmail1">Username</label>
                                ...
                                <a  class="text-secondary hover-text-primary d-block mt-4" href="/Project_HCD/user/forgotpassword">I forgot my password !</a>
								<a  class="text-secondary hover-text-primary d-block mt-4" href="/Project_HCD/user/registration">Don't have an account? Register</a>
                            </form>
