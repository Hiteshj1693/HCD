...
<%@ page import="com.Project_HCD.model.State"%>
<%@ page import="com.Project_HCD.model.City"%>
<%@ page import="com.Project_HCD.model.Area"%>
											...
											<div class="col-lg-4 col-md-4">
												<div class="form-group">
													...
													<form:input type="number" name="pincode" path="pincode"
														class="form-control" pattern="[1-9]{6}" title="Enter Valid Pin Code eg-380015" required="true"/>
												</div>
											</div>
										</div>
									</div>
						...
						<c:choose>
										<c:when test="${edit}">
											...
											<c:forTokens var="token" items="${property.propertyPicture}" delims="|">
												<div id="dvPreview">
													<img alt=""
														src="/Project_HCD/resources/images/propertyPicture/${token}"
														style="height: 100px; width: 100px">
												</div>
												</c:forTokens>
												<input type="file" id="propertyPicture" name="propertyPicture" path="propertyPicture"
													value="D:/Jva_tools/apache-tomcat-9.0.22/webapps/Project_HCD/resources/images/propertyPicture/${property.propertyPicture}" multiple/>
												<hr />
												<br />
					...
					<c:choose>
						<c:when test="${edit}">
							<input class="btn btn-primary btn-round" type="submit"
								value="Update" formaction="/Project_HCD/property/updateProperty" />
						</c:when>
						<c:otherwise>
							<input class="btn btn-primary btn-round" type="submit"
								value="Submit" formaction="/Project_HCD/property/addProperty" />
						</c:otherwise>
					</c:choose>
					</form:form>
